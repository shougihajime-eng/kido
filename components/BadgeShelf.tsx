        ...
        {badges.map((b, i) => {
          ...
          return (
            <motion.li
              ...
              className={`relative aspect-square rounded-2xl border flex flex-col items-center justify-center gap-1 p-2 ${
                b.earned
                  ? 'bg-accent-soft border-accent shadow-[0_0_16px_rgba(212,162,76,0.25)]'
